...
public class MapPane extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        double lat = (double) ib.get("lat");
        double longt = (double) ib.get("long");
        ...
        mMap.addMarker(new MarkerOptions().position(latLong).title("You are here!").snippet("Consider yourself located"));
